...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'user.address.name'           => 'required',
            'user.address.postcode'       => 'required|numeric',
            'user.address.city'           => 'required|alpha_dash',
            'user.address.county'         => 'required|alpha_dash',
            'user.address.administrative' => 'required|alpha_dash',
            'user.address.country'        => 'required|alpha_dash',
